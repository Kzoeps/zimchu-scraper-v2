...
POST_MESSAGE_OG = (
    "data.node.group_feed.edges[0].node.comet_sections.content.story.message.text"
)
...
ATTACHMENTS_OG = (
    "data.node.group_feed.edges[0].node.comet_sections.content.story.attachments[0]"
)
